...
import { clipLineToWidth, extractSegments, normalizeTerminalOutput, sliceWithWidth, visibleWidth } from "./utils.js";
...
export interface Component {
	...
	/** Invalidate any cached rendering state so the next render rebuilds from scratch. */
	invalidate(): void;
}
